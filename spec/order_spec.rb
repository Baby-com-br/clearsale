    ...
    describe ".to_xml" do
      ...
      context "when birthdate is empty" do
        it "should not send birthdate" do
          _user.birthdate = nil
          expect(described_class.to_xml(_order, _payment, _user)).to_not include "<BirthDate>"
        end
